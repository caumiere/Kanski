...
export const portfolioEntries: PortfolioEntry[] = [
  {
    ...
    blurb: "Segment hosted and co-produced by Kandon Fears for Word Around Campus.",
  ...
  },
  {
    ...
    kind: "video",
    category: "Broadcast Hosting",
    blurb: "Second Word Around Campus sample showing continued hosting and co-producing work.",
    dateLabel: "Broadcast Sample",
    clientLabel: "Word Around Campus",
  ...
  },
  {
    ...
    blurb: "Venom Affairs hosting sample included in Kandon Fears' broadcast portfolio.",
    dateLabel: "Broadcast Sample",
  ...
  },
  {
    ...
    blurb: "Coverage of a marathon senate session shaped by leadership changes and impeachment debate.",
  ...
  },
  {
    ...
    blurb: "Report on the induction of new senators and the priorities they brought into student government.",
  ...
  },
  {
    ...
    kind: "article",
    category: "Campus Politics",
    blurb: "A report on concern and confusion surrounding student government funds and the investigation that followed.",
  ...
  },
  {
    ...
    blurb: "A student-life story on off-campus living and the tradeoffs that come with it.",
  ...
  },
  {
    ...
    kind: "article",
    category: "Community",
    blurb: "A local feature on how the Greenwise-to-Publix conversion changed a student-facing space near campus.",
  ...
  },
  {
    ...
    blurb: "Coverage of a zoning fight that put a fraternity property dispute before city leadership.",
  ...
  },
  {
    ...
    kind: "article",
    category: "Campus Politics",
    blurb: "A senate report centered on confirmation of a new Secretary of Graduate Affairs.",
  ...
  },
  {
    ...
    kind: "article",
    category: "Campus News",
    blurb: "A campus news story on FAMU’s passport fair and study-abroad opportunity building.",
  ...
  },
  {
    ...
    blurb: "A sports commentary piece examining the attention around HBCU coaching staffs.",
  ...
  },
  {
    ...
    kind: "article",
    category: "Profile",
    blurb: "A profile piece on student leader Jeffrey Francis and the themes behind his run for office.",
  ...
  },
  {
    ...
    kind: "article",
    category: "Opinion",
    blurb: "An opinion piece on emotional vulnerability, masculinity, and Valentine’s Day.",
...
export const faqEntries: FaqEntry[] = [
  {
    ...
    answer:
      "The portfolio combines broadcast hosting samples, co-produced segments, and individually linked published writing by Kandon Fears.",
  },
  {
    id: "02",
    question: "Where were the articles originally published?",
    answer: "The writing archive links to stories published by The FAMUAN.",
  },
  {
    id: "03",
    question: "What video work is featured?",
    answer:
      "The current package selection includes Word Around Campus hosting samples and a Venom Affairs hosting segment.",
  },
  {
    id: "04",
    question: "Are the videos embedded from their original source?",
    answer: "Yes. The package pages embed the original YouTube videos using the provided timestamps.",
  },
  {
    id: "05",
    question: "Can more stories and packages be added later?",
    answer:
      "Yes. The content model is set up so more articles and creative work can be slotted into the site without rebuilding the layout.",
  },
  {
    id: "06",
    question: "What does this portfolio highlight most?",
    answer:
      "It emphasizes broadcast presence, newsroom reporting, and published campus and community journalism from Kandon Fears.",
  },
];
